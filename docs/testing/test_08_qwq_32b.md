# TEST_08: QwQ-32B-Preview — Multi-Hardware Execution & Scale Audit
...
**Test Objective**: Verify multi-tier memory placement (VRAM $\to$ RAM $\to$ NVMe) and decoding throughput for QwQ-32B-Preview (32.8B) with 0 bytes of local disk download.
...
| Comparison Metric | Physical Baseline Limit (RTX 4050) | QwQ-32B-Preview Live Result | Authentic Multiplier |
|---|---|---|---|
| **vs Native 4-bit VRAM Limit** | ~7.0B – 8.0B Q4 (Fits in 6GB VRAM) | `qwq:32b` (32.8B) | **4.69× More Parameters** |
| **vs Native 16-bit VRAM Limit** | ~3.0B FP16 (Fits in 6GB VRAM) | `qwq:32b` (32.8B) | **10.93× More Parameters** |
| **Active Math vs Dense 32B** | 32.76B Dense (65.5 GFLOPs/tok) | `qwq:32b` (32.8B) | **1.0× Compute Ratio** |
