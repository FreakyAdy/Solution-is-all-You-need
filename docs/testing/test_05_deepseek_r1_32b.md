# TEST_05: DeepSeek-R1-Distill-Qwen-32B — Multi-Hardware Execution & Scale Audit
...
**Test Objective**: Verify multi-tier memory placement (VRAM $\to$ RAM $\to$ NVMe) and decoding throughput for DeepSeek-R1-Distill-Qwen-32B (32.8B) with 0 bytes of local disk download.
...
| Comparison Metric | Physical Baseline Limit (RTX 4050) | DeepSeek-R1-Distill-Qwen-32B Live Result | Authentic Multiplier |
|---|---|---|---|
| **vs Native 4-bit VRAM Limit** | ~7.0B – 8.0B Q4 (Fits in 6GB VRAM) | `deepseek-r1:32b` (32.8B) | **4.69× More Parameters** |
| **vs Native 16-bit VRAM Limit** | ~3.0B FP16 (Fits in 6GB VRAM) | `deepseek-r1:32b` (32.8B) | **10.93× More Parameters** |
| **Active Math vs Dense 32B** | 32.76B Dense (65.5 GFLOPs/tok) | `deepseek-r1:32b` (32.8B) | **1.0× Compute Ratio** |
